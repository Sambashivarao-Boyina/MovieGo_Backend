...
const { createBooking, getBookingDetails, cancelBooking, checkoutBooking, getBookingsList } = require("../../Controllers/User/Booking.js");
...
router.get("/", IsAutheticated, isUser, WrapAsync(getBookingsList));
